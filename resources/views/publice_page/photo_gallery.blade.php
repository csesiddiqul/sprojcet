							...
							<div class="commite-card">
								<div class="row">
									<div class="col-md-12 col-sm-12">
										<a href="subfolder-img.html">
											<div class="item item-control">
												<img src="img/slider/Untitled-3.jpg" class="img-fluid ..box-img-2-3">
						...
						<div class="col-md-3">
							<div class="commite-card">
								<div class="row">
									<div class="col-md-12 col-sm-12">
										<div class="item item-control">
											<img src="img/slider/Untitled-2.jpg" class="img-fluid ..box-img-2-3">
											<a href="" class="title">Sed massa dui!</a>
											<p class="details">Tristique tincidunt cursus sed, ornare ncidunt eque a tristique. <a class="readmore mt-2" href="">Read more...</a></p>
										</div>
									</div>
						...
						<div class="col-md-3">
							<div class="commite-card">
								<div class="row">
									<div class="col-md-12 col-sm-12">
										<div class="item item-control">
											<img src="img/slider/Untitled-3.jpg" class="img-fluid .box-img-2">
											<a href="" class="title">Sed massa dui!</a>
											<p class="details">Tristique tincidunt cursus sed, ornare ncidunt eque a tristique. <a class="readmore mt-2" href="">Read more...</a></p>
										</div>
									</div>
						...
						<div class="col-md-3">
							<div class="commite-card">
								<div class="row">
									<div class="col-md-12 col-sm-12">
										<div class="item item-control">
											<img src="img/slider/Untitled-2.jpg" class="img-fluid .box-img-2">
											<a href="" class="title">Sed massa dui!</a>
											<p class="details">Tristique tincidunt cursus sed, ornare ncidunt eque a tristique. <a class="readmore mt-2" href="">Read more...</a></p>
										</div>
									</div>
