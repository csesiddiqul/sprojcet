            ...
            <table id="example2" class="table table-bordered table-hover">
                ...
                @foreach($results as $key => $notice)
                    <tr>
                        ...
                        <td>
                            <a href="{{route('notice.edit',$notice->id)}}" class="btn btn-success btn-xs"><i class="fa-solid fa-pen-to-square"></i> Edit</a>


                            <a class="btn btn-info btn-xs" href="{{route('notice.show',$notice->id)}}">Show</a>
