                        ...
                        <form action="{{route('event.update', $event->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control"   name="description" id="exampleInputDescription" cols="30" rows="10">{{$event->description}}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" value="{{$event->Priority}}" name="priority" class="form-control" id="exampleInputTitle" placeholder="Enter priority">
                                    @error('priority')
                                    <span class="note-help-block text-danger">
                                            <strong>{{$message}}</strong>
                                        </span>
